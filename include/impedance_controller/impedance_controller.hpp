...
#ifndef IMPEDANCE_CONTROLLER__FORWARD_CONTROLLERS_BASE_HPP_
#define IMPEDANCE_CONTROLLER__FORWARD_CONTROLLERS_BASE_HPP_
...
typedef trajectory_msgs::msg::JointTrajectoryPoint JointTrajectoryPoint;
...
protected:
  ...
  /**
   * @brief Read the most currently available state information from hardware interface
   * 
   * @param state destination for current state information
   */
...
#endif  // IMPEDANCE_CONTROLLER__FORWARD_CONTROLLERS_BASE_HPP_